import { Sandpack, CodeEditor, SandpackProvider, SandpackThemeProvider } from '@codesandbox/sandpack-react'
...
const RenderSandpack = (props) => {
  ...
  const { children, template = 'react', file = '/App.js'} = props
  ...
  return (
    <SandpackProvider>
      <SandpackThemeProvider theme={aquaBlue}>
        <button
        ...
        <CodeEditor
          ...
          code={children.trim()}
          readOnly
          fileType={(props.className || 'language-js').replace(/language-/, '')}
        />
