...
import type { TableVirtuosoHandle, TableVirtuosoProps } from './component-interfaces/TableVirtuoso'
import useChangedListContentsSizes from './hooks/useChangedChildSizes'
import useSize from './hooks/useSize'
import useWindowViewportRectRef from './hooks/useWindowViewportRect'
import type { ComputeItemKey, FixedFooterContent, FixedHeaderContent, ItemContent, TableComponents, TableRootProps } from './interfaces'
...
const DefaultFillerRow = ({ height }: { height: number }) => (
  <tr>
    <td style={{ height: height, padding: 0, border: 0 }} />
  </tr>
)
