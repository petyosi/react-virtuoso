...
[columns](/data-table/columns/). For visual changes, see
[Editable Wrapper](/data-table/customization/shadcn-wrapper/) and
[Styling](/data-table/customization/styling-cells-headers-and-rows/).
