...
The important change is where table structure lives: `TableVirtuoso` receives row renderers;
data-table receives a data source and column declarations, then feature modules add table behavior.
