...
The default table renders its own scrolling element. Three props change that — pick one when the table needs to share a viewport with page chrome or a custom scroller.
