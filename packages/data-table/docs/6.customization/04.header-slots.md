...
Header slots let you add behavior UI around the header label without replacing the whole header. Use
them for sort buttons, filter menus, resize handles, reorder grips, and drop indicators.
