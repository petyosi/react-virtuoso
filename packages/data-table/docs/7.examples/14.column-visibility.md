...
Persisted visibility is keyed by `field`, not by the generated runtime column key. Renaming a field invalidates its saved visibility — see [Field names are the persistence contract](/data-table/features/state-persistence/#field-names-are-the-persistence-contract) for the migration rule.
