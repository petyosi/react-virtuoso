...
description: Persist model query state and column widths for a remote table.
sidebar:
...
Use this pattern when the table should remember both the data query and the user's layout choices.
