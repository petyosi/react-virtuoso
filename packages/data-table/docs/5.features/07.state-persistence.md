...
visibility, and model query state. It is opt-in at two levels:
...
Reload the page after hiding a column or resizing a header. The table restores only the state owned
