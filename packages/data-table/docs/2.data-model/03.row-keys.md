...
- `context` — the table's [`context` prop](/data-table/customization/context/), useful for scoping keys across tenants, saved views, or other instances that might share row IDs
