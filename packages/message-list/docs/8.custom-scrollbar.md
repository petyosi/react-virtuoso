...
title: Virtuoso Message List Custom Scrollbar
description: Integrate SimpleBar and other custom scrollbar libraries with VirtuosoMessageList using customScrollParent.
