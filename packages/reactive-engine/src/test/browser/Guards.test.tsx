...
describe('Guards', () => {
  ...
  it.skip('executes guard and blocks navigation on abort', async () => {
    const admin$ = Route('/admin', () => <div>Admin Page</div>)
    const home$ = Route('/', () => {
    ...
    function TestApp() {
      ...
      return (
        <div>
          ...
          <Router guards={[blockGuard]} routes={[home$, admin$]} />
        </div>
      )
    }
    ...
    await screen.getByText('Go to Admin').click()
  ...
  it.skip('stops on first abort result', async () => {
    const executionOrder: number[] = []
    ...
    function TestApp() {
      ...
      return (
        <div>
          ...
          <Router guards={[guard1, guard2, guard3]} routes={[home$, admin$]} />
        </div>
      )
    }
  ...
  it.skip('handles async guard that returns abort', async () => {
    const admin$ = Route('/admin', () => <div>Admin Page</div>)
    const home$ = Route('/', () => {
      const goToHome = usePublisher(home$)
    ...
    const asyncAbortGuard = Guard('/admin', async () => {
      await new Promise((resolve) => setTimeout(resolve, 50))
      // return abort()
    })
    ...
    function TestApp() {
      ...
      return (
        <div>
          ...
          <Router guards={[asyncAbortGuard]} routes={[home$, admin$]} />
        </div>
      )
    }
    ...
    // Should still be on home page after async guard aborts
    await expect.element(screen.getByText('Home Page')).toBeInTheDocument()
  })
  ...
  it.skip('does not render route when guard aborts', async () => {
    const admin$ = Route('/admin', () => <div>Admin Page</div>)
    const home$ = Route('/', () => {
      const goToHome = usePublisher(home$)
    ...
    function TestApp() {
      ...
      return (
        <div>
          ...
          <Router guards={[abortGuard]} routes={[home$, admin$]} />
        </div>
      )
    }
