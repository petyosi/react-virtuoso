...
If your data objects keep stable references across updates, `itemIdentity` is usually not necessary. Add it when controlled prepend or trimming loses the previous visual position, or when anchored replacement cannot find a recreated record.
