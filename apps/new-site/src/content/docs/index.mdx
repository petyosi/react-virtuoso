...
<FeatureGrid>
  <FeatureCard title="Zero Configuration" icon="gear" href="/react-virtuoso/1.virtuoso/auto-resizing/">
  ...
  <FeatureCard title="Performance at Scale" icon="rocket" href="/react-virtuoso/1.virtuoso/basic-usage/">
    Smooth scrolling with thousands of items through virtualized rendering.
  </FeatureCard>

  <FeatureCard title="Bi-directional Loading" icon="double-arrow" href="/react-virtuoso/1.virtuoso/endless-scrolling/">
