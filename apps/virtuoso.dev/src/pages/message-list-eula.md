# Virtuoso Message List End User License Agreement
...
The specific details of the license granted depend on the 3. License model selected by Licensee. The access to software updates is governed by 7. Updates.
