...
import { parseCodeBlockTitle, parseLanguage, parseLines, containsLineNumbers, useCodeWordWrap } from '@docusaurus/theme-common/internal'
...
export default function CodeBlockString({
  ...
  return (
    <Container
      as="div"
      className={clsx(blockClassName, language && !blockClassName.includes(`language-${language}`) && `language-${language}`)}
    >
