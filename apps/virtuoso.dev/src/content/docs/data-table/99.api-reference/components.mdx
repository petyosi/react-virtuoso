...
#### components?: `NoInfer`\<[`DataTableComponents`](../customization/#datatablecomponents)\<`Context`\>\>


Component overrides for internal DOM elements like rows, sticky headers, and sticky column containers.
See [DataTableComponents](../customization/#datatablecomponents) for available slots.
